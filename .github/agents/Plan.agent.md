...
handoffs:
  - label: Start Implementation
    agent: agent
    prompt: 'Start implementation based on the plan above. The detailed plan is in /memories/session/plan.md — read it before beginning.'
    send: true
    # Prerequisite: /memories/session/plan.md must exist before using this handoff
